            ...
            <RowBetween style={{ flexWrap: 'wrap', marginBottom: '2rem', alignItems: 'flex-start' }}>
              <RowFixed style={{ flexWrap: 'wrap' }}>
                <RowFixed style={{ alignItems: 'baseline' }}>
                  ...
                  <TYPE.main fontSize={below1080 ? '1.5rem' : '2rem'} fontWeight={700} style={{ margin: '0 1rem' }}>
                    <RowFixed gap="6px">
                  ...
                  {!below1080 && (
                    <>
                      <TYPE.main fontSize={'1.5rem'} fontWeight={700} style={{ marginRight: '1rem' }}>
                        {price}
                      </TYPE.main>
                      {priceChange}
                    </>
              ...
              <PanelWrapper style={{ marginTop: below1080 ? '0' : '1rem' }}>
                ...
                <Panel>
                  <AutoColumn gap="20px">
                    ...
                    <RowBetween align="flex-end">
                      <TYPE.main fontSize={'2rem'} lineHeight={1} fontWeight={700}>
                        {liquidity}
                      </TYPE.main>
